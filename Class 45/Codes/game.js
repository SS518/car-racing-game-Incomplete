 class Game {
    ...
    async start(){
      ...
      car1 = createSprite(350,2200)
      car2 = createSprite(350,2200)
    ...
    play(){
     ...
     //   image(backgroungIMG,0,-displayHeight+10,3450,displayHeight+100)
     //   image(backgroungIMG,-50,-200,3450,displayHeight+100)
        image(backgroungIMG,0,displayHeight+275,3450,displayHeight+100)
